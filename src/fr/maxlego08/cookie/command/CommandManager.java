...
import fr.maxlego08.cookie.zcore.logger.Logger.LogType;
...
public class CommandManager extends ZUtils implements CommandExecutor, TabCompleter {
     ...
     * @param cookiePlugin
     */
    public CommandManager(CookiePlugin cookiePlugin) {
    ...
    public void registerCommand(Plugin plugin, String string, VCommand vCommand, List<String> aliases) {
        try {
            ...
            if (vCommand.getPermission() != null) command.setPermission(vCommand.getPermission());
