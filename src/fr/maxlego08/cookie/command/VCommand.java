package fr.maxlego08.cookie.command;
...
import fr.maxlego08.cookie.zcore.utils.commands.Arguments;
import fr.maxlego08.cookie.zcore.utils.commands.CollectionBiConsumer;
import fr.maxlego08.cookie.zcore.utils.commands.CommandType;
import fr.maxlego08.cookie.zcore.utils.commands.Tab;
...
public abstract class VCommand extends Arguments {
     ...
     */
    public VCommand(CookiePlugin plugin) {
        super();
        this.plugin = plugin;
    }
     ...
     */
    public CommandType prePerform(CookiePlugin plugin, CommandSender commandSender, String[] args) {
     ...
     * @return the command type.
     */
    protected abstract CommandType perform(CookiePlugin plugin);
     ...
     */
    public List<String> toTab(CookiePlugin plugin, CommandSender sender, String[] args) {
